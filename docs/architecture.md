...
The application deliberately contains no activity synchronization, analytics, scoring, or LLM calls. The live Strava integration currently provides OAuth connection and token lifecycle behavior plus a pure provider-to-domain activity normalization boundary.
